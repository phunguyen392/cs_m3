...
<div class="container">
 ...
 <div class="col-lg-6">
        ...
        <form method="post" action="">
                        ...
                        <input placeholder="Password..." class="form-control form-control-user" type="password" name="password" id="password" value="<?php echo isset($data['password']) ? $data['password'] : ''; ?>"/>
...
<?php
        ...
        if (!empty($_POST['xuly']))
        {
            ...
            if (empty($data['email'])){
                ...
                echo '<script language="javascript">alert("Chưa nhập email kìa ông nội "); window.location="login.php";</script>';

            }
            else if (!is_email($data['email'])){
                $error['email'] = 'Email không đúng định dạng';
                // echo 'Email không đúng định dạng <br>';
                echo '<script language="javascript">alert("Email không đúng định dạng"); window.location="login.php";</script>';

            }
            if (empty($data['password'])){
                $error['password'] = 'Đó! lại còn quên nhập mật khẩu ';
                // echo 'Đó! lại còn quên nhập mật khẩu <br>';
                echo '<script language="javascript">alert("Đó! lại còn quên nhập mật khẩu"); window.location="login.php";</script>';
    ...
    if (empty($error)) {
        ...
        $valid_password = '123'; // Mật khẩu hợp lệ
        ...
        echo '<script>window.location.href = "index.php?controller=category&action=index";</script>';
            ...
            echo '<script language="javascript">alert("Email hoặc mật khẩu không chính xác"); window.location="login.php";</script>';
